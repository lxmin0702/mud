...
<div class="M-20">
	<div class="tong1">
    	...
    	<dl><input type="text" id="userName" name="userName" maxlength="15" class="tinput" onblur="ifName()" placeholder="请输入用户名">
        </dl>
    </div>
    <div class="tong1">
  ...
  <!--  <div id="level" class="pw-strength" style="margin-left: 27%;">           	
	...
	<div class="tong1">
    	<label>备注</label>
    	<dl><textarea type="textarea" id="remarks" name="remarks" maxlength="1024" class="tinput" style="height:80px;resize:none;"></textarea>
    	</dl>
	</div>
</div>
</body>
