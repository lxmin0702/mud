...
<div class="Frm-formD"><abbr><font>*</font>用户名：</abbr>
	<dl><input class="in-T W6b"  id="userName" onblur="ifName()" <shiro:lacksRole name="1">disabled</shiro:lacksRole> /></dl></div>
...
<shiro:hasRole name="1">
	<div class="Frm-formD"><abbr>备注：</abbr>
		<dl><textarea type="textarea" id="remarks"  name="remarks" maxlength="1024" placeholder="请输入备注信息" class="in-T W6b" style="height:80px;resize:none;"></textarea>
	</div>
</shiro:hasRole>
</div>
</body>
